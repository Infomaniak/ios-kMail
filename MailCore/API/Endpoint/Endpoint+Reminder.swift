...
public extension Endpoint {
    static func reminder(mailboxUuid: String, folderId: String, messageId: String) -> Endpoint {
        return .mailbox(uuid: mailboxUuid).appending(path: "/folder/\(folderId)/message/\(messageId)/reminder")
    }
