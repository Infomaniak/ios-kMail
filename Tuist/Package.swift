...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Infomaniak/ios-core-ui", .upToNextMajor(from: "24.11.0")),
        ...
        .package(url: "https://github.com/Infomaniak/swift-rich-html-editor", branch: "feat/get-selection"),
