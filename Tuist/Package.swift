...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Infomaniak/ios-core", branch: "feat/Get-phones-and-emails-in-UserProfile"),
        ...
        .package(url: "https://github.com/Infomaniak/ios-features", branch: "chore/Bump-add-phones-and-emails-in-UserProfile"),
