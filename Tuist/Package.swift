...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Infomaniak/ios-core", branch: "feat/better-app-assembly-sharing"),
        .package(url: "https://github.com/Infomaniak/ios-core-ui", .upToNextMajor(from: "24.4.3")),
        ...
        .package(url: "https://github.com/Infomaniak/swift-rich-html-editor", .upToNextMajor(from: "3.2.0")),
