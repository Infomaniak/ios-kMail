...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Infomaniak/ios-core", .upToNextMajor(from: "16.0.1")),
        .package(url: "https://github.com/Infomaniak/ios-core-ui/", .upToNextMajor(from: "22.2.4")),
