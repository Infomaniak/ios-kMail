...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Infomaniak/ios-core", branch: "feat/device-manager-capabilities"),
        .package(url: "https://github.com/Infomaniak/ios-core-ui", .upToNextMajor(from: "23.0.0")),
        .package(url: "https://github.com/Infomaniak/ios-create-account", .upToNextMajor(from: "22.0.0")),
        ...
        .package(url: "https://github.com/Infomaniak/ios-features", branch: "feat/inapp2fa-i18n"),
        .package(url: "https://github.com/Infomaniak/ios-login", .upToNextMajor(from: "7.3.0")),
        .package(url: "https://github.com/Infomaniak/ios-notifications", .upToNextMajor(from: "13.0.0")),
