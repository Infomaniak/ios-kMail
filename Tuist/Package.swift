...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Infomaniak/ios-bug-tracker", branch: "chore/Update-coreui-version"),
        .package(url: "https://github.com/Infomaniak/ios-core", .upToNextMajor(from: "18.12.0")),
        .package(url: "https://github.com/Infomaniak/ios-core-ui", branch: "chore/bump"),
        .package(url: "https://github.com/Infomaniak/ios-create-account", branch: "chore/Update-coreui-version"),
        ...
        .package(url: "https://github.com/Infomaniak/ios-features", branch: "chore/Update-coreui-version"),
        ...
        .package(url: "https://github.com/Infomaniak/ios-version-checker", branch: "chore/Update-coreui-version"),
