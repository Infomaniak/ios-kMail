...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Infomaniak/ios-features", .upToNextMajor(from: "10.1.0")),
        ...
        .package(url: "https://github.com/Infomaniak/swift-rich-html-editor", branch: "feat/tag-in-editor"),
