...
├── MailCoreUI/                  # Shared UI components framework (Reactions, RecipientChip, ViewModifiers, etc.)
...
├── .github/workflows/           # GitHub Actions (CI, lint, format, periphery, semantic-commit, UI tests, etc.)
...
```bash
# Install mise it's not yet installed
