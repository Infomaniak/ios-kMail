...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Infomaniak/ios-core", revision: "da6a3fa3a35be975e068ce59ee43d4b05ecabb9d"),
        ...
        .package(url: "https://github.com/Infomaniak/ios-onboarding", .upToNextMajor(from: "1.0.2")),
