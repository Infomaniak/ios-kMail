...
struct ExternalExpeditorView: View {
    @Environment(\.dismiss) private var dismiss

    var body: some View {
        VStack(alignment: .leading, spacing: 24) {
            Text(MailResourcesStrings.Localizable.externalDialogTitleExpeditor)
...
struct ExternalExpeditorView_Previews: PreviewProvider {
