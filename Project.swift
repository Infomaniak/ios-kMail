...
let project = Project(name: "Mail",
                      packages: [
                          ...
                          .package(url: "https://github.com/Infomaniak/swift-concurrency", .upToNextMajor(from: "0.0.3")),
                          .package(
                          ...
                          .package(url: "https://github.com/Infomaniak/SQRichTextEditor", .upToNextMajor(from: "1.1.0")),
